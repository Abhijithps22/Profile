...
function App() {
  return (
    <div className="App">
      <div className="card">
        <div className="img">
          <img src="assets/_DSC0176.JPG" alt="" />
        </div>
        <span style={{ color: " rgb(228, 240, 228)" }} id="name">
          Hey!
        </span>
        ...
        <div className="share">
          ...
          <a
            href="https://www.linkedin.com/in/abhijith-ps-7712a0253/"
            target="blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a href="https://www.instagram.com/abhi_jith_abi_" target="blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
